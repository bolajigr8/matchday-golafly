...
const EARN_ICONS = [Ticket, Plane, Building2, Smartphone, Users]
        ...
        {EARN_WAYS.map((way, i) => {
          ...
          return (
            ...
            >
              ...
              <p className='mt-2 sm:mt-2.5 font-heading text-[11px] sm:text-[12px] font-bold text-foreground'>
                {way.label}
              </p>
