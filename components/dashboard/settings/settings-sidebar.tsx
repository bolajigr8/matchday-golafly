  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='divide-y divide-border'>
          {QUICK_SHORTCUTS.map(({ icon: Icon, iconBg, iconColor, label }) => (
            ...
            >
              ...
              <span className='flex-1 font-heading text-[13px] font-bold text-foreground'>
                {label}
              </span>
        ...
        <div className='divide-y divide-border'>
          {[
            ...
            },
            {
              ...
              iconColor: 'text-[#60A5FA]',
              label: 'Price Alerts',
              sub: 'Get notified when prices drop for your saved items.',
            },
            {
              ...
              sub: 'Access your tickets and trip details offline.',
            },
            {
      ...
      <motion.div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 70% 110%, #0e2010 0%, #080c08 100%)',
        }}
      >
        {/* Soccer ball decoration */}
        <div className='pointer-events-none absolute bottom-0 right-0 w-30 opacity-40'>
          <img
        ...
        <div className='relative z-10 p-5'>
          ...
          <p className='mt-2 text-[12px] text-muted-foreground leading-snug max-w-40'>
            Update your settings to get the most out of Matchday.
          </p>
          <Link
            href='#'
            className='mt-4 inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2.5 font-heading text-[13px] font-bold text-background transition-opacity hover:opacity-90'
          >
