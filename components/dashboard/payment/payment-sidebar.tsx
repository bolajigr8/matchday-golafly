  ...
  return (
    <div className='relative mx-auto flex h-42.5 w-42.5 items-center justify-center'>
      ...
      <div className='relative z-10 text-center'>
        <p className='font-heading text-[17px] font-bold leading-tight text-foreground'>
          $2,480.50
        </p>
  ...
  return (
    <div className='space-y-4'>
      ...
      <motion.div
        ...
        className='rounded-2xl border border-border bg-card p-4 sm:p-5'
      >
        <h2 className='font-heading text-[15px] sm:text-[17px] font-bold text-foreground mb-3 sm:mb-4'>
          Payment Security
        </h2>
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(180deg, rgba(3,9,3,0.88) 0%, rgba(3,9,3,0.82) 100%)',
          }}
        />

        <div className='relative z-10 p-4 sm:p-5'>
          <h3 className='font-heading text-[16px] sm:text-[18px] font-bold text-foreground leading-tight'>
            Book more,
            <br />
            save more!
          </h3>
          <p className='mt-1.5 text-[11px] sm:text-[12px] text-white/70 leading-snug'>
            Get exclusive member deals on flights, hotels and more.
          </p>
          ...
          <Link
            href='#'
            className='mt-4 sm:mt-5 inline-flex items-center gap-2 rounded-xl bg-primary px-4 sm:px-5 py-2.5 font-heading text-[12px] sm:text-[13px] font-bold text-background transition-opacity hover:opacity-90'
          >
