...
const STEPS = ["Seats", "Extras", "Checkout", "Confirmed"] as const;

export function StepProgress({ currentStep }: { currentStep: 1 | 2 | 3 | 4 }) {
  return (
    <motion.div
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              <motion.span
                className={cn(
                  ...
                  active &&
                    "border-primary bg-primary text-primary-foreground shadow-[0_0_8px_rgba(183,255,0,0.4)]",
