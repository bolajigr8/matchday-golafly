...
const GRADIENT_BG = "/figma/footer/f0a42d752c8086e9be6b45641ffeb2e31cc642cc.png";
const GRID_BG     = "/figma/footer/80f0d270a559b792b5b5bf890834121eb11d171f.png";
      ...
      <div className="page-container py-14 sm:py-16">
        ...
        <section className="grid gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-[1fr_repeat(5,auto)]">
          ...
          <div className="space-y-5">
            ...
            {/* Social links — from store/data.ts */}
