...
export function PaymentsClient() {
  return (
    <div className='p-4 sm:p-6 space-y-6'>
      {/* Page header */}
      <div>
        <h1 className='font-heading text-[26px] sm:text-[36px] font-bold leading-tight text-foreground'>
          Payments
        </h1>
        <p className='mt-1 text-[12px] sm:text-[14px] text-muted-foreground'>
          Manage your payments, methods and view your transaction history.
        </p>
      </div>
