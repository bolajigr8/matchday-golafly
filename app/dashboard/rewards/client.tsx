            ...
            <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
              <div>
                ...
                <p className='mt-1.5 text-[11px] sm:text-[12px] text-muted-foreground'>
                  Keep going! You're {DASHBOARD_USER.pointsToNext} points away
                  from{' '}
        ...
        <aside className='space-y-4'>
          ...
          <div className='rounded-2xl border border-border bg-card p-4 sm:p-5'>
            ...
            <div className='mt-3 flex items-center gap-3'>
              <div className='flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-amber-500/20 text-[22px] sm:text-[24px]'>
                🛡️
              </div>
              <div>
          ...
          <div className='overflow-hidden rounded-2xl border border-border bg-card'>
            <div className='p-4'>
              ...
              <button className='mt-3 flex items-center gap-2 rounded-xl bg-primary px-4 py-2 font-heading text-[11px] sm:text-[12px] font-bold text-background transition-opacity hover:opacity-90'>
                Explore Offers <ArrowRight className='h-3.5 w-3.5' />
              </button>
            </div>
            <div className='h-16 bg-linear-to-b from-primary/10 to-transparent' />
          </div>
        </aside>
      </div>
    </div>
